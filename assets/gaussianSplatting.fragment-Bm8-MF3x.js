...
`;e.ShadersStoreWGSL[p]||(e.ShadersStoreWGSL[p]=m);var h=[c,s,l,t,n,f,o,i,d,a,r,u];for(let t of h)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var g={name:p,shader:m};export{g as gaussianSplattingPixelShaderWGSL};